		...
		<div class="flex flex-col gap-6">
			<Card>
				...
				<CardContent>
					...
					{#if message}
						<Alert variant="destructive" class="mb-4 animate-in duration-300 fade-in-0">
	...
	<div>
		<form method="POST" action="?/signInEmail">
			<FieldGroup>
				...
				<FieldDescription class="flex w-full justify-center">
					Don't have an account? <a class="ml-1" href={resolve('/register')}>Sign Up</a>
				</FieldDescription>
			</FieldGroup>
		</form>
	</div>
		...
		<div class="w-full">
			...
			<Button variant="outline" type="submit" class="h-10 w-full">
				{#if provider.toLowerCase() === 'google'}
					<svg
						class="size-5 fill-(--color-foreground)"
						width="800px"
						height="800px"
						viewBox="0 0 32 32"
						version="1.1"
